...
The Lancet Regional Health – Americas; la revista publica en inglés, véase prose_en.py).
...
def nw(x, fem=False):
    """Números de uno a diez en palabras (estilo Lancet); mayores en cifras. `fem` da «una» para 1."""
    try:
        xi = int(x)
