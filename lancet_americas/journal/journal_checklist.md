# Journal checklist — *The Lancet Regional Health – Americas*, measured on the built files (build of 2026-09-09T20:38, after the second reading round)
...
deliverables in `manuscript/04_submission_lancet_americas/` — `article_sin_rett_en.pdf` (31 pages, A4), `supplement_sin_rett_en.pdf`
...
| Check | Value |
|---|---|
| `python -m pytest lancet_americas/tests -q` | 330 passed, 4 skipped, 99 warnings, 121 subtests passed in 367.59s (0:06:07) / EXIT 0 |
