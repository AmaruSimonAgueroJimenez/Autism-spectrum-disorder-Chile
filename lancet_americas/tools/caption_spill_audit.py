...
(`review.layout.caption_spill.unmarked_spills`, que tiene que ser 0).
    ...
    python lancet_americas/tools/caption_spill_audit.py lancet_americas/manuscript --out spill.json
"""
...
def main(argv=None) -> int:
    ...
    ap.add_argument("build_dir", type=Path, help="directorio con los DOCX y sus PDF (p. ej. lancet_americas/manuscript)")
