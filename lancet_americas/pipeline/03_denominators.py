#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""03_denominators.py — Capas de denominador y cobertura + crosswalk comunal (módulo 03 del pipeline Lancet).
...
Ejecución (desde la raíz del repositorio):
    python3 lancet_americas/pipeline/03_denominators.py [--tmpdir DIR]
"""
...
SCRIPT = "lancet_americas/pipeline/03_denominators.py"
...
def main():
    ...
    ARGS = args
    t0 = time.time()
    tmp_root = Path(args.tmpdir) if args.tmpdir else Path(tempfile.mkdtemp(prefix="lancet_03_"))
