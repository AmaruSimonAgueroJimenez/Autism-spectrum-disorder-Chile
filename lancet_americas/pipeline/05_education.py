...
Principios aplicados (PROMPT_CODEX_LANCET_AMERICAS.md §6 y DATA_REVIEW.md):
...
Ejecución: `python3 lancet_americas/pipeline/05_education.py [--skip-junaeb] [--junaeb-years 2023 2024 2025]`
"""
...
MODULE = "05_education"
SCRIPT = "lancet_americas/pipeline/05_education.py"
