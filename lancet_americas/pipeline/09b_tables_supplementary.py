# -*- coding: utf-8 -*-
"""09b_tables_supplementary.py — tablas suplementarias ST1–ST14 del estudio multisistema (Lancet Regional Health – Americas).
...
Uso (desde la raíz del repositorio):  python3 lancet_americas/pipeline/09b_tables_supplementary.py
"""
