...
a la norma (180 × 245 mm, 3 × 2, cuerpo base 8 pt, mínimo 6 pt, letras minúsculas), que:
  ...
  4. la puerta automática (`LANCET_PLATE_CHECK`) hace fallar el módulo que produzca una lámina mala, y
     todos los módulos que dibujan láminas pasan por ella.

Con LANCET_PLATE_REAL=1 se añade la comprobación sobre una lámina REAL reconstruida por su módulo.
"""
...
@unittest.skipUnless(os.environ.get("LANCET_PLATE_REAL") == "1",
                     "reconstrucción de una lámina real: LANCET_PLATE_REAL=1")
