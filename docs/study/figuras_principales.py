"""Main figures 1–4 of the manuscript (version 10), in English and Spanish, for docs/study.

Adapted copy of `technical/sources/build_v10_main_figures.py` of revision 10. It reads the public copies in
`docs/study/data/` (the commune comparison uses `communes_public.csv`, without identifiers and with cells
of 1 to 4 records masked) and writes `docs/study/figures/<language>/Figure_N.*`.
