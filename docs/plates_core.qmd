...
kpis([
    ("16", "Plates redrawn here, with their code"),
    ("4", "Plates kept as stored images"),
    ("20", "Plates in this chapter"),
])
```

Of the 20 plates in this chapter, 16 are redrawn from the published tables by the code shown
...
```{python}
#| label: lamina-figs6_rem_stable_panel
#| fig-cap: "Figure S6. Redrawn here from the published tables by the code above."
import sys
from pathlib import Path
...
_STUDY = ROOT / "docs" / "study"          # docs/study, so `figstyle` resolves
if str(_STUDY) not in sys.path:
    sys.path.insert(0, str(_STUDY))
...
# ---------------------------------------------------------------------------------------------- draw
def draw_figS6_rem_stable_panel():
