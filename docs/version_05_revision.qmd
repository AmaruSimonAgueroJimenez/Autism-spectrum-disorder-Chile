---
title: "Version 05 results: the tidy baseline"
subtitle: "Scientific revision (2026-09-10) - 48 result tables, none of them changed from the previous version"
---
...
This page is the result set of version 05 of the study. The tables below ship with the repository, so
...
show_table(pd.DataFrame(inventory), "The 48 result tables of the baseline", {"Size (KB)": 1})
```

## Every result table of version 05
