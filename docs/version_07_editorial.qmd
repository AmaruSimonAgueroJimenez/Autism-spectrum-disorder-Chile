---
title: "Version 07 results: the editorial restructure"
subtitle: "Bilingual editorial revision (2026-09-10) - 62 result tables, none of them changed from the previous version"
---
...
This page is the result set of version 07 of the study. The tables below ship with the repository, so
...
show_table(pd.DataFrame(inventory), "Tables added by version 07 to the 59 of version 06", {"Size (KB)": 1})
```

## Every result table of version 07
