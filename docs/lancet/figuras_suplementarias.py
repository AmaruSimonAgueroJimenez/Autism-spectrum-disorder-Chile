"""Supplementary figures S2–S9 of the manuscript (version 10), in English and Spanish, for docs/lancet.

Adapted copy of `technical/sources/build_v10_supp_figures.py` of revision 10. S1 (data flow) and S6
(territorial maps) are static plates inherited from revision 09, stored in `docs/lancet/figures/<language>/`;
