# -*- coding: utf-8 -*-
"""config.py — rutas, años, variantes de definición y códigos del estudio multisistema.
...
#:   SUBMISSION  the journal package built for the target journal (one case
...
SUBMISSION = MANUSCRIPT / "04_submission_study"
