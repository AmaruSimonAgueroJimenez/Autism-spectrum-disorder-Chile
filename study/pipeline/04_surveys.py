...
Ejecución desde la raíz del repositorio:
    python3 study/pipeline/04_surveys.py [--skip-design-check] [--mc-replicates 400] [--tmpdir DIR]

Salidas (escritura atómica):
    study/outputs/tidy/survey_estimates.csv
    study/outputs/tidy/survey_items_dictionary.csv
    study/outputs/tidy/survey_design_check.csv
    study/outputs/controls/04_surveys_controls.csv
"""
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--tmpdir", default=os.environ.get("STUDY_TMPDIR"), help="directorio para la extracción temporal del ZIP ENDIDE (por defecto el temporal del sistema)")
