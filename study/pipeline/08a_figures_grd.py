...
Lee únicamente las tablas tidy de `study/outputs/tidy/` producidas por los módulos 01–06 y escribe:
...
Ejecución: `python3 study/pipeline/08a_figures_grd.py` desde la raíz del repositorio. No modifica config/common/labels.
"""
...
SCRIPT = "study/pipeline/08a_figures_grd.py"
