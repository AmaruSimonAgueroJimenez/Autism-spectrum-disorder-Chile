...
Lee EXCLUSIVAMENTE las tablas tidy ya verificadas de `study/outputs/tidy/` y `outputs/values_<variante>.json`;
...
Uso: python3 study/pipeline/15_extra_figures_context.py
...
SCRIPT = "study/pipeline/15_extra_figures_context.py"
