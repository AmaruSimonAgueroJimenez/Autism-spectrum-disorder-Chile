...
"""run_all.py — ejecuta los pasos numerados del pipeline en orden, desde un entorno limpio.
    ...
    python study/pipeline/run_all.py            # todos los pasos
    python study/pipeline/run_all.py --from 06  # desde el paso 06
    python study/pipeline/run_all.py --only 02  # un solo paso
    python study/pipeline/run_all.py --list     # muestra los pasos detectados
