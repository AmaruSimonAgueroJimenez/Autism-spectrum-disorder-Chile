#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""01_grd_core.py — Núcleo hospitalario GRD 2019–2024 (paso 01 del pipeline la revista de destino).
...
Uso: python3 study/pipeline/01_grd_core.py [--years 2019 ... 2024] [--chunksize 200000] [--no-hash]
