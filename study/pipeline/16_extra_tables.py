...
Tablas producidas (22 por variante e idioma):
  ...
  E81  inventario de todas las figuras, tablas y ecuaciones del proyecto, con el rótulo actual de cada pieza
       ...
       FIGURE_ORDER/TABLE_ORDER, equations.NUMBER) y una columna que dice dónde se usa
...
Uso:
    python3 study/pipeline/16_extra_tables.py
    python3 study/pipeline/16_extra_tables.py --variants con_rett --langs en
"""
...
SCRIPT = "study/pipeline/16_extra_tables.py"
...
#     ecuaciones             -> equations.NUMBER        (los PNG se imprimen numerados en la
...
def _registry():
    ...
    if cached is None:
        ...
        import equations as EQ             # NUMBER (ecuaciones de la metodología extendida)
...
def build_E81(I: Inputs, variant: str, lang: str, reg: Registry, cache: dict) -> pd.DataFrame:
    ...
    note = {"es": ("Inventario de todos los archivos de figura, tabla y ecuación presentes para esta variante y este "
                   ...
                   "equations.NUMBER; el prefijo heredado del título se borra con la misma expresión regular "
            ...
            "en": ("Inventory of every figure, table and equation file present for this variant and language at the "
                   ...
                   "supplementary_material.TABLE_ORDER, and equations in equations.NUMBER; the inherited prefix "
    ...
    for v in CFG.VARIANTS:
        for lg in CFG.LANGUAGES:
            ...
            ctl.add("E81_equations_numbered", key, len(R81["equations"]),
                    ...
                    "PNG de ecuación inventariados frente a los que declara equations.paths_for; cada uno "
                    "lleva el número de equations.NUMBER y la letra de su línea")
