...
Reglas (ver ../analysis_plan.md y scripts/downloads/DATA_REVIEW.md):
...
Ejecución (desde la raíz del repositorio):
    python3 study/pipeline/02_rem_pathway.py [--years 2019 2025] [--chunksize N]
"""
...
SCRIPT = "study/pipeline/02_rem_pathway.py"
