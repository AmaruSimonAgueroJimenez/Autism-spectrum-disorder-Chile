# -*- coding: utf-8 -*-
"""07_controls.py — consolidación de los controles de reproducción (esperado frente a observado) del pipeline del estudio.
...
Salidas
  outputs/controls/controls_summary.csv    consolidado con ÁMBITO explícito: scope, module, name, key, expected, observed,
                                           ...
                                           ámbitos cuentan cosas distintas y NO se suman: `study/controls_registry.py`
...
Uso (desde la raíz del repositorio):  python3 study/pipeline/07_controls.py
"""
...
TXT = {
    ...
    "md_scopes_note": {"es": "Los dos ámbitos cuentan cosas distintas y NO se suman: `pipeline` es una fila por control escrito por cada módulo; "
                             ...
                             "debe nombrar su ámbito en palabras (`study/controls_registry.py`)."},
