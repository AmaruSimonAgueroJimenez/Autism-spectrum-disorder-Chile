...
def part_texts(lang: str, R, standalone: bool = False) -> tuple[str, str]:
    ...
    import equations as EQ  # import local: evita un ciclo si el módulo se importa temprano
    ...
    # y la única excepción, las tablas metodológicas: la decisión está en study/decision_log.md
...
def counts() -> dict:
    ...
    `study/pipeline/08d_figure_dataflow.py` y en `study/tests/test_self_counts.py`.
    """
    import equations as EQ  # import local: evita un ciclo si el módulo se importa temprano
