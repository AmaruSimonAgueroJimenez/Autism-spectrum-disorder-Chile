...
Measured on `manuscript/04_submission_study/article_sin_rett_en.pdf` (build of 2026-09-09, after the second reading round): 30
...
`references.bib` (122 verified entries) and in the full bilingual corpus.
