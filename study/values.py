# -*- coding: utf-8 -*-
"""values.py — cantidades citadas por el manuscrito del estudio (una tabla plana por variante).
...
def _controls(V: dict) -> None:
    ...
    # llevan el prefijo controls_plan_* y las de la T8 el prefijo t8_. Ver study/controls_registry.py.
