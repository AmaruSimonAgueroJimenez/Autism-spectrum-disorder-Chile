# -*- coding: utf-8 -*-
"""prose_en.py — English manuscript and supplementary appendix for the target journal.
...
* Citations use [@key] markers whose keys must exist in references.bib; the core text targets <= 30 keys and
...
def nw(x):
    """Numbers one to ten in words (journal style), larger numbers as digits."""
    try:
        xi = int(x)
